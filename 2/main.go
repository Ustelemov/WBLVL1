...
func getPowChan(c chan<- int, in [5]int) {
	for _, v := range in {
		c <- v * v
	}
	close(c)
...
func main() {
	//Создадим массив, сразу проиницилизировав его значениям, так как он задан строго по заданию
	inputArr := [5]int{2, 4, 6, 8, 10}
